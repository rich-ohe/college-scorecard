...
## Installation
This site is made with [Jekyll], a static website generator made with Ruby.
Once you've got [Ruby] on your computer, you
 run the following commands to install all the ruby gems you need:
...
```
export API_BASE_URL=https://api.data.gov/ed/collegescorecard/v1/ ; export API_KEY=yourkeyhere
```
